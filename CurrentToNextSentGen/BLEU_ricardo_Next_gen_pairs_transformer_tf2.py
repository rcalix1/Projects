...
def get_en_and_sp_sentences(train_dict):
    ...
    for key, val in train_dict.items():
        print(key)
        print(val)
        en_list.append(      val['sent1']        )
        sp_list.append(      val['sent2']        )
...
train_dict   = load_dictionary("data/DictPairs/pairs_train_dictionary.txt")
test_dict    = load_dictionary("data/DictPairs/pairs_test_dictionary.txt")
...
f_out = open("output/pairs_pred_out.txt", "w")
...
for i in range(   len(test_english_sentence_list)    ):
    ...
    if (i % 100 == 0):
        ...
        print("Real sent1 input: ",       en_sentence)
        print("Real sent2 translation: ", sp_sentence)

        print("predicted sent2 sentence")
